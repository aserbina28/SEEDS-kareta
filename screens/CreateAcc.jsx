    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.textContainer}>
        <Text style={styles.infoText}>
          If you want to be a driver on the app, please submit your valid
          driver's license and a proof of vehicle insurance. When you're done or
          in case you don't want to be a driver, press "next".
        </Text>
      </View>
      ...
      <View>
        ...
        >
          <Text style={styles.buttonsText}>Driver's License</Text>
        </TouchableOpacity>
        ...
        >
          <Text style={styles.buttonsText}>Vehicle Insurance</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.buttons}
          onPress={() => {
